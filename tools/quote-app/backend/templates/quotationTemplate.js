  ...
  const products = quotation.products.map(product => {
    ...
    return `
        <tr>
            ...
            <td style="text-align: right">₹${product.sellingPrice.toFixed(2)}</td>
            <td style="text-align: center">${product.gstPercentage}%</td>
                ...
                <div class="totals-container">
                    <div class="totals">
                        ...
                        <div class="total-item">
                            ...
                            <span class="total-value">₹${gstTotal.toFixed(2)}</span>
                        </div>
